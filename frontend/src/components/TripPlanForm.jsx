	...
	return (
		<div className='w-3/5 flex flex-col items-center bg-yellow-100 p-4'>
			<form className='w-5/6'>
				...
				<br></br>
				<input className='w-[120px] h-8 pl-2 border-2 border-solid border-gray-300 focus:border-black focus:outline-none' type="text" id='state'/>
				<br></br>
				<label for="date">Date</label>
				<br></br>
				<input className='w-[120px] h-8 pl-2 border-2 border-solid border-gray-300 focus:border-black focus:outline-none' type="date" id='state'/>
				<br></br>
